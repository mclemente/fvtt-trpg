	...
	cleric: {
		subclasses: {
			...
			"life-domain": {
				...
				features: {
					1: [
						"Compendium.trpg.classfeatures.68bYIOvx6rIqnlOW",
						"Compendium.trpg.classfeatures.jF8AFfEMICIJnAkR",
						"Compendium.trpg.spells.8dzaICjGy6mTUaUr",
						"Compendium.trpg.spells.uUWb1wZgtMou0TVP",
					],
		...
		subclasses: {
			...
			champion: {
				...
				features: {
					...
					10: ["Compendium.trpg.classfeatures.kYJsED0rqqqUcgKz"],
